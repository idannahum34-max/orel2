...
const galleryItems: GalleryItem[] = [
  { src: '/imgs/product1.jpg', title: 'נר בהתאמה אישית', subtitle: 'נר מעוצב עם שם, הקדשה או מסר אישי בקו נקי ומרגש.' },
  { src: '/imgs/product2.jpg', title: 'דובי פרחים', subtitle: 'מתנה עדינה ומלאת נוכחות לרגעים יפים, אירועים והפתעות מיוחדות.' },
  { src: '/imgs/product3.jpg', title: 'קולקציית דובים', subtitle: 'מבחר עיצובים רכים ומלאי אופי למתנה שמושכת את העין.' },
  { src: '/imgs/product4.jpg', title: 'פרח פיסולי', subtitle: 'פריט דקורטיבי עדין שמשתלב נהדר באירוח, במארזים ובעיצוב הבית.' },
  { src: '/imgs/product5.jpg', title: 'דובי ורוד', subtitle: 'בחירה מתוקה, נעימה ומדויקת למתנה אישית עם טאץ׳ בוטיקי.' },
]

const collectionCards = [
  {
    icon: <Sparkles className="h-5 w-5" />,
    title: 'עבודת יד מוקפדת',
...
const processSteps = [
  {
    number: '01',
    title: 'שולחים השראה',
    text: 'מספרים למי מיועדת המתנה, איזה סגנון אהבתם ואילו פרטים חשובים לכם.',
  },
  {
    number: '02',
    title: 'בוחרים התאמה',
    text: 'מדייקים צבעים, טקסט אישי, סוג נר או מארז, ומרכיבים יחד את העיצוב המתאים.',
  },
  {
    number: '03',
    title: 'מקבלים יצירה מוכנה',
    text: 'הפריט נארז בקפידה ומוכן להענקה או להצבה בבית — עם נראות אסתטית ומוקפדת.',
  },
]

const benefits = [
  { icon: <ShieldCheck className="h-5 w-5" />, title: 'גימור מוקפד', text: 'קו נקי, חומרים שנבחרים בקפידה ונראות שמרגישה איכותית.' },
  { icon: <Heart className="h-5 w-5" />, title: 'חוויה אישית', text: 'ליווי נעים, התאמות מדויקות ותשומת לב לפרטים הקטנים.' },
    ...
    <div dir="rtl" className="min-h-screen overflow-x-hidden bg-[#f8f3ec] text-[#241f1d]">
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 md:py-16 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:py-20">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-[#e7d9c8] bg-white/78 px-4 py-2 text-sm font-medium text-[#80684f] shadow-sm">
                ...
                נרות בעבודת יד ומתנות בהתאמה אישית
              </div>
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-[#625548]">
                OREL יוצרת נרות מעוצבים, פריטי שעווה ומארזים בהתאמה אישית — בקו נקי, רך ויוקרתי שמתאים למתנות,
                אירועים ולעיצוב הבית.
              </p>
              ...
              <div className="grid gap-4 sm:grid-cols-[1.08fr_0.92fr] sm:items-stretch">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="rounded-[30px] border border-[#eadfce] bg-[#fffaf4] p-6 shadow-[0_22px_60px_rgba(120,95,67,0.1)]">
                    <img src="/imgs/orel-logo.png" alt="Orel Handmade Candles" className="mx-auto h-28 w-auto object-contain sm:h-32" />
                    <p className="mt-4 text-center text-base leading-7 text-[#67594b]">
                      הסמל של OREL מייצג קו עדין, נשי ומוקפד — עם חוויית בוטיק שמתחילה בנראות וממשיכה בכל פרט.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mx-auto max-w-6xl px-4 pb-4 sm:px-6 lg:px-8">
          <div className="rounded-[40px] border border-[#eadfce] bg-white/88 px-6 py-10 text-center shadow-[0_24px_70px_rgba(104,82,57,0.08)] md:px-10 md:py-12">
            <img src="/imgs/orel-logo.png" alt="Orel Handmade Candles" className="mx-auto h-24 w-auto object-contain sm:h-28 md:h-32" />
            <h2 className="mt-5 text-3xl font-semibold text-[#241f1d] sm:text-4xl">המותג OREL במרכז הבמה</h2>
            <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-[#67594b]">
              אתר שמציג את העבודות של אוראל בצורה נקייה, מדויקת ומכבדת — עם נוכחות ברורה ללוגו ולשפה המותגית.
            </p>
          </div>
        </section>
          ...
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[32px] border border-[#eadfce] bg-white/82 p-7 shadow-[0_18px_60px_rgba(96,78,55,0.07)] md:p-9">
              ...
              <p className="mt-5 text-lg leading-8 text-[#63574c]">
                כל נר נוצר מתוך אהבה לפרטים הקטנים: צורה, גוון, ריח, אריזה וחוויית פתיחה. המטרה היא ליצור פריט שמרגיש
                אישי, יפה ומדויק — לא עוד מוצר מדף, אלא מתנה עם מחשבה.
              </p>
            </div>
        ...
        <section id="gallery" className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-xl text-base leading-7 text-[#6e6257]">
              תצוגה נקייה של העבודות של אוראל בלבד — ללא תמונות חיצוניות וללא תוכן שלא שייך למותג.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
            ...
            <div className="space-y-5">
              <div className="rounded-[36px] border border-[#eadfce] bg-[linear-gradient(180deg,#fffefc_0%,#f8f2ea_100%)] p-7 shadow-[0_18px_60px_rgba(104,82,57,0.08)] md:p-8">
                <h3 className="text-2xl font-semibold text-[#241f1d]">מה מקבלים?</h3>
                <div className="mt-5 space-y-3">
                  {[
                    'התאמה אישית של צבעים, טקסט או סגנון בהתאם לבקשה.',
                    'נראות בוטיקית, אריזה מוקפדת וחוויית מתנה נעימה.',
                    'ליווי ברור ופשוט משלב הרעיון ועד לפריט המוכן.',
                  ].map((item) => (
          ...
          <div className="overflow-hidden rounded-[40px] border border-[#eadfce] bg-[linear-gradient(135deg,#ffffff_0%,#f7f1e9_100%)] p-7 shadow-[0_26px_80px_rgba(107,83,56,0.1)] md:p-12">
            <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <div className="rounded-[32px] border border-white/80 bg-white/90 p-5 shadow-[0_16px_50px_rgba(97,74,49,0.08)] md:p-6">
                ...
                <div className="mt-5 rounded-[26px] border border-[#efe4d6] bg-[#fffaf4] p-5 text-center">
                  <img src="/imgs/orel-logo.png" alt="Orel Handmade Candles" className="mx-auto h-20 w-auto object-contain" />
                  <h3 className="mt-3 text-2xl font-semibold text-[#241f1d]">עיצוב שמרגיש אישי</h3>
                  <p className="mt-3 text-base leading-7 text-[#6b5f53]">
                    מתנות קטנות עם נראות גדולה — בעיצוב רך, מדויק ומוכן לאירוח, להענקה או לפינה יפה בבית.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="border-t border-[#eadfce] bg-white/70">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-8 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div className="flex items-center gap-3">
            <img src="/imgs/orel-logo.png" alt="Orel Handmade Candles" className="h-12 w-12 rounded-xl object-cover object-center shadow-sm" />
            <div>
