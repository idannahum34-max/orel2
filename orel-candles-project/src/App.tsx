...
const galleryItems: GalleryItem[] = [
  { src: '/imgs/product3.jpg', title: 'קולקציית דובים', subtitle: 'מבחר עיצובים למתנה מרשימה, רכה ומלאת אופי.' },
  { src: '/imgs/product4.jpg', title: 'פרח פיסולי', subtitle: 'פריט דקורטיבי עדין שמשתלב באירוח, במארזים ובעיצוב הבית.' },
  { src: '/imgs/product5.jpg', title: 'דובי ורוד', subtitle: 'בחירה מתוקה ומלאת נוכחות למתנה אישית או לשולחן מעוצב.' },
  { src: '/imgs/candle1.jpg', title: 'נר טבעי', subtitle: 'מראה חם ונקי שמשדר בוטיקיות ואלגנטיות.' },
  { src: '/imgs/candle2.jpg', title: 'סטייל בוטיק', subtitle: 'צילום נקי, גימור מוקפד ועיצוב שנעים להעניק ולקבל.' },
  { src: '/imgs/candle4.jpg', title: 'אווירה רגועה', subtitle: 'פריטי שעווה שמוסיפים רוך, חום וסגנון לחלל.' },
]
              ...
              <div className="grid gap-4 sm:grid-cols-[1.08fr_0.92fr] sm:items-stretch">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="rounded-[30px] border border-[#eadfce] bg-[#fffaf4] p-6 shadow-[0_22px_60px_rgba(120,95,67,0.1)]">
                    <div className="text-sm font-semibold tracking-[0.22em] text-[#a77e56]">OREL STUDIO</div>
                    <h2 className="mt-3 text-2xl font-semibold text-[#241f1d]">עיצוב רגוע, מוקפד ומלא אופי</h2>
                    <p className="mt-3 text-base leading-7 text-[#67594b]">
                      פריטים שמביאים איתם רוך, אלגנטיות ונגיעה אישית — למתנה, לאירוע או לפינה יפה בבית.
                    </p>
                    <div className="mt-5 flex flex-wrap gap-2 text-sm text-[#7a6a5a]">
                      ...
                      <span className="rounded-full bg-white px-3 py-2">מארזים מעוצבים</span>
                      <span className="rounded-full bg-white px-3 py-2">קו עדין ויוקרתי</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section id="gallery" className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-xl text-base leading-7 text-[#6e6257]">
              הצצה לעיצובים, מרקמים ומארזים — בתצוגה נקייה ומסודרת, ללא כפילויות ובקו שמכבד את המותג.
            </p>
          </div>

          <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {galleryItems.map((item) => (
              <article key={item.src} className="group overflow-hidden rounded-[30px] border border-[#eadfce] bg-white p-3 shadow-[0_18px_60px_rgba(120,92,64,0.07)]">
                <div className="overflow-hidden rounded-[22px]">
                  <img src={item.src} alt={item.title} className="h-[320px] w-full object-cover transition duration-700 group-hover:scale-105" />
                </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <div className="rounded-[32px] border border-white/80 bg-white/90 p-5 shadow-[0_16px_50px_rgba(97,74,49,0.08)] md:p-6">
                ...
                <div className="mt-5 rounded-[26px] border border-[#efe4d6] bg-[#fffaf4] p-5">
                  <div className="text-sm font-semibold tracking-[0.2em] text-[#a77e56]">OREL</div>
